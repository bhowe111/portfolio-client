  ...
  return (
    <main className="bg-blue-150 min-h-screen p-12">
      <section className="container mx-auto">
        ...
        <h2 className="text-lg text-gray-500 flex justify-center mb-12">Welcome ye olde ales</h2>
        ...
        {projectData && projectData.map((project, index) => (
          ...
          <article className="relative rounded-lg shadow-xl bg-white p-16">
            ...
            <div className="text-gray-500 text-xs space-x-4">
              ...
              <p className="text-lg my-6 text-gray-700 leading-relaxed">{project.description}</p>
